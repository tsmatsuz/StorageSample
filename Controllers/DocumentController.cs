    ...
    public class DocumentController : Controller
    {
        ...
        public ActionResult SaveToSkydrive(string code)
        {
            ...
            if (string.IsNullOrEmpty(code))
                return Redirect(@"https://login.live.com/oauth20_authorize.srf?client_id=" + HttpUtility.UrlEncode(SkyDriveUtil.CLIENT_ID) + "&scope=wl.signin%20onedrive.readwrite&response_type=code&redirect_uri=" + HttpUtility.UrlEncode(SkyDriveUtil.REDIRECT_URL));
